  ...
  return (
    <figure className="identity-field" aria-label="Ahmad Hassan, a portrait formed from particles">
      <div className="portrait-fallback">
        <Image src="/portraits/ahmad-particle-violet.png" alt="Ahmad Hassan, rendered as a cyan and violet triangular particle portrait" fill sizes="(max-width: 850px) 100vw, 55vw" preload />
      </div>
